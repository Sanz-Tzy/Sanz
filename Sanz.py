...
def info_tools():
    ...
    print\n ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] Welcome to Tools       \x1b[1;93m'%(N,H,N);time.sleep(0.07)
    print\n ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] TEAM     \x1b[1;93m: XNX-CODE TEAM 2021.'%(N,H,N);time.sleep(0.07)
    print\n ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] Author   \x1b[1;93m: Sanz-Tzy \x1b[1;93mX Haris Ganz.'%(N,H,N);time.sleep(0.07)
    print\n ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] Github   \x1b[1;93m: https://github.com/Sanz-Tzy'%(N,H,N);time.sleep(0.07)
    ...
    print\n ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] WhatsApp \x1b[1;93m: +628727xxxx'%(N,H,N);time.sleep(0.07)
    print\n ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] WhatsApp \x1b[1;93m: Jangan lupa Follow dan Like github saya!'%(N,H,N);time.sleep(0.07)
    print\n ' %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] Catatan  \x1b[1;93m: Kunjungi Facebook Saya Bintang Tzy'%(N,H,N);time.sleep(0.07)
    print ' %s╠══[%s#%s]'%(N,O,N), 52 * '\x1b[1;92m-\x1b[0m';time.sleep(0.07)
    print('%s \x1b[1;92m║'%(O))
